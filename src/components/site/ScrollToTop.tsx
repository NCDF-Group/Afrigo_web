  ...
  return (
    ...
    >
      <svg viewBox="0 0 48 48" className="absolute inset-0 h-full w-full -rotate-90" aria-hidden="true">
        ...
        <circle cx="24" cy="24" r={RADIUS} fill="none" stroke="#E3B02E" strokeWidth="2.5" strokeLinecap="round" strokeDasharray={CIRCUMFERENCE} strokeDashoffset={CIRCUMFERENCE * (1 - progress)} className="scroll-ring" />
      </svg>
